...
class AnsibleInventoryDownscaler(Step):
    ...
    def generate_temporary_downscale_groups(self):
        return [
            AnsibleInventoryItem(
                'kubernetes_node_downscale',
                self.proxy.get_cancelled_node_hosts(),
            ),
        ]
    ...
    def get_inventory(self):
        ...
        inventory.extend(self.generate_temporary_downscale_groups())
